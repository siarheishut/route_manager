      ...
      TestCase{
          ...
          .want = PostBusRequest{
              ...
              .stops = {"stop1", "stop1", "stop2", "stop1", "stop2",
                        "stop3", "stop2", "stop1", "stop2", "stop1", "stop1"}},
      },
      TestCase{
...
TEST(TestParseRequests, PostStopRequest) {
  ...
  std::vector<TestCase> test_cases{
      ...
      TestCase{
          .name = "New format - several stops long names",
  ...
  std::vector<TestCase> test_cases{
      ...
      TestCase{
          ...
          .input = "6\n"
                   ...
                   "fifth\n"
                   "Bus 4: stop2 > stop4 > stop7 > stop2\n"
                   "Stop Stop2: 35.395105, 82.385629, 6000000m to Stop1\n",
          .want = {{
                       PostBusRequest{
                           .bus = "1",
